...
def revokeIngress(data):
    ...
    # print(data["IpPermissions"][0]['IpRanges'])
    # print(data["IpPermissions"][0]['UserIdGroupPairs'])
    # print(type(data["IpPermissions"][0]['UserIdGroupPairs']))
    # print(len(data["IpPermissions"][0]['UserIdGroupPairs']))
